...
public class Level7 extends Game implements Screen {
    ...
    private TextButton.TextButtonStyle chapter1Style,chapter2Style,chapter3Style,chapter4Style,chapter5Style,chapter6Style,
            ...
            chapter14Style,chapter15Style,chapter16Style,chapter17Style,chapter18Style,chapter19Style,chapter20Style;//change
    ...
    public TextButton chapter1,chapter2,chapter3,chapter4,chapter5,chapter6,chapter7,chapter8,chapter9,chapter10,chapter11,chapter12,
            chapter13,chapter14,chapter15,chapter16,chapter17,chapter18,chapter19,chapter20;
    //change
    private Skin skin;
    ...
    public Level7(Lone_Warrior1 game){
        this.game = game;
        ...
        chapter16Style=new TextButton.TextButtonStyle();            //button 1 properties
        chapter16Style.up= skin.getDrawable("icon");
        chapter16Style.down=skin.getDrawable("icondown");
        chapter16Style.font=font1;
        if(game.getPrefs().getBoolean("unlock"+levelstate+"16")==true){
            chapter16Style.fontColor=Color.BLACK;
            chapter16= new TextButton("Act 16",chapter16Style);}
        else{
            chapter16Style.fontColor=Color.FIREBRICK;
            chapter16= new TextButton("Locked",chapter16Style);}

        chapter17Style=new TextButton.TextButtonStyle();            //button 1 properties
        chapter17Style.up= skin.getDrawable("icon");
        chapter17Style.down=skin.getDrawable("icondown");
        chapter17Style.font=font1;
        if(game.getPrefs().getBoolean("unlock"+levelstate+"17")==true){
            chapter17Style.fontColor=Color.BLACK;
            chapter17= new TextButton("Act 17",chapter17Style);}
        else{
            chapter17Style.fontColor=Color.FIREBRICK;
            chapter17= new TextButton("Locked",chapter17Style);}

        chapter18Style=new TextButton.TextButtonStyle();            //button 1 properties
        chapter18Style.up= skin.getDrawable("icon");
        chapter18Style.down=skin.getDrawable("icondown");
        chapter18Style.font=font1;
        if(game.getPrefs().getBoolean("unlock"+levelstate+"18")==true){
            chapter18Style.fontColor=Color.BLACK;
            chapter18= new TextButton("Act 18",chapter18Style);}
        else{
            chapter18Style.fontColor=Color.FIREBRICK;
            chapter18= new TextButton("Locked",chapter18Style);}

        chapter19Style=new TextButton.TextButtonStyle();            //button 1 properties
        chapter19Style.up= skin.getDrawable("icon");
        chapter19Style.down=skin.getDrawable("icondown");
        chapter19Style.font=font1;
        if(game.getPrefs().getBoolean("unlock"+levelstate+"19")==true){
            chapter19Style.fontColor=Color.BLACK;
            chapter19= new TextButton("Act 19",chapter19Style);}
        else{
            chapter19Style.fontColor=Color.FIREBRICK;
            chapter19= new TextButton("Locked",chapter19Style);}

        chapter20Style=new TextButton.TextButtonStyle();            //button 1 properties
        chapter20Style.up= skin.getDrawable("icon");
        chapter20Style.down=skin.getDrawable("icondown");
        chapter20Style.font=font1;
        if(game.getPrefs().getBoolean("unlock"+levelstate+"20")==true){
            chapter20Style.fontColor=Color.BLACK;
            chapter20= new TextButton("Act 20",chapter20Style);}
        else{
            chapter20Style.fontColor=Color.FIREBRICK;
            chapter20= new TextButton("Locked",chapter20Style);}
        ...
        table2.add(chapter1).expandX().padTop(60).width(120).height(140);
        table2.add(chapter2).expandX().padTop(60).width(120).height(140);
        table2.add(chapter3).expandX().padTop(60).width(120).height(140);
        table2.add(chapter4).expandX().padTop(60).width(120).height(140);
        table2.add(chapter5).expandX().padTop(60).width(120).height(140);
        table2.row();
        ...
        table2.row();
        table2.add(chapter16).expandX().width(120).height(140);
        table2.add(chapter17).expandX().width(120).height(140);
        table2.add(chapter18).expandX().width(120).height(140);
        table2.add(chapter19).expandX().width(120).height(140);
        table2.add(chapter20).expandX().width(120).height(140);
    ...
    public void show() {
        ...
        chapter16.addListener(new InputListener(){           //Button properties!
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button){
                return true;
            }
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
                if(game.getPrefs().getBoolean("unlock"+levelstate+"16")==true){
                    audio.playbSound(1);
                    stage.dispose();
                    game.setScreen(new StoryView(game,-3.5f,levelstate,16,600));}
            }
        });

        chapter17.addListener(new InputListener(){           //Button properties!
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button){
                return true;
            }
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
        ...
        chapter18.addListener(new InputListener(){           //Button properties!
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button){
                return true;
            }
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
        ...
        chapter19.addListener(new InputListener(){           //Button properties!
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button){
                return true;
            }
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
        ...
        chapter20.addListener(new InputListener(){           //Button properties!
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button){
                return true;
            }
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
